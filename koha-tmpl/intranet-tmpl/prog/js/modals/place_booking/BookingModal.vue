        ...
        <div class="modal-dialog booking-modal-window" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body booking-modal-body">
                    <form id="form-booking" @submit.prevent="handleSubmit">
                        ...
                        <fieldset class="step-block">
                            ...
                            <div class="form-group">
                                ...
                                <v-select
                                    ...
                                    :clearable="true"
                                    :disabled="!bookingPatron"
                                />
                                <span
                                    v-if="constrainedFlags.pickupLocations"
...
export default {
    ...
    props: {
        ...
        pickupLibraryId: { type: [Number, String], default: null },
    ...
    setup(props, { emit }) {
        ...
        watch(
            ...
            val => {
                isOpen.value = val;
                if (val) {
                    resetModalState(); // Reset general modal things
                }
            }
        );
        ...
        watch(
            ...
            ([patron, pickupLocations]) => {
                if (!patron || bookingPickupLibraryId.value) return;
...
.booking-marker-grid {
    ...
    gap: 0.25em; /* Space between booking-marker-item elements */
    width: fit-content;
    max-width: 90%; /* Or adjust as needed */
    margin-left: auto;
    margin-right: auto;
    line-height: normal; /* Reset line height for items within */
}
...
.booking-marker-count {
    font-size: 0.7em; /* Smaller than day number */
    margin-left: 0.125em;
    line-height: 1; /* Keep it compact */
    font-weight: normal; /* Default weight, can be boldened if needed */
    color: var(--bs-body-color); /* Standard text color */
}

.booking-marker-dot--booked {
    background: #ffc107; /* Original color */
}

.booking-marker-dot--checked-out {
    background: var(--bs-danger-bg-subtle); /* Original color */
}

.booking-marker-dot--lead {
    background: var(--bs-info-bg-subtle); /* Original color */
}

.booking-marker-dot--trail {
    background: var(--bs-warning-bg-subtle); /* Original color */
}
...
.flatpickr-day.booking-day--hover-lead {
    background-color: rgba(
        ...
        7,
        0.2
    ) !important; /* bs-warning with alpha */
    /* Optional: add a subtle border or outline if needed for more emphasis */
...
.flatpickr-day.booking-day--hover-trail {
    background-color: rgba(
        ...
        240,
        0.2
    ) !important; /* bs-info with alpha */
    /* Optional: add a subtle border or outline */
    /* outline: 1px solid rgba(13, 202, 240, 0.4); */
}
</style>
