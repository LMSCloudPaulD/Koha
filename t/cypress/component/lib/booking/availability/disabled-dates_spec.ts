...
import { createDisableFunction } from "@koha-vue/components/Bookings/lib/booking/availability/disabled-dates.js";
import { buildIntervalTree } from "@koha-vue/components/Bookings/lib/booking/algorithms/interval-tree.js";
import { extractBookingConfiguration } from "@koha-vue/components/Bookings/lib/booking/availability/rules.js";
...
describe("createDisableFunction (end-date-only mode)", () => {
    it("blocks a start date when no single item can serve the full fixed period (any item)", () => {
        ...
        const fn = makeDisableFn({
            ...
            bookableItems: [item("1"), item("2")],
            bookings: [
                booking("1", "2026-03-21", "2026-03-21", { booking_id: 1 }),
                booking("2", "2026-03-23", "2026-03-23", { booking_id: 2 }),
            ],
            selectedDates: [],
        });
        expect(fn(new Date(2026, 2, 20))).to.be.true;
