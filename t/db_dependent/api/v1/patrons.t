...
subtest 'get() tests' => sub {
    ...
    subtest 'library embed' => sub {
        ...
        $t->get_ok( "//$userid:$password@/api/v1/patrons/" . $patron->id => { "x-koha-embed" => "library" } )
            ->status_is(200)
            ->json_is( '/library/library_id' => $patron->branchcode )
            ->json_is( '/library/name'       => $patron->library->branchname );
